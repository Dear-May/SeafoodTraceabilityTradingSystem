<template>
  <div class="my-haichao-page" :class="{ 'night-mode': isNightMode }">
    ...
    <div class="main-content">
      ...
      <div class="logistics-section">
        ...
        <div class="logistics-list">
          <div class="logistics-item" v-for="logistics in logisticsInfo" :key="logistics.id">
            ...
            <div class="logistics-details col-9" class="text-left">
      ...
      <div class="logistics-section">
        <h4 class="text-left">常买常逛&nbsp;&nbsp;<el-icon>
          <DishDot/>
        </el-icon>
        </h4>
        <el-divider></el-divider>
      ...
      <div class="logistics-section">
        <h4 class="text-left">猜你喜欢&nbsp;&nbsp;<i class="bi bi-balloon-heart"></i>
        </h4>
        <el-divider></el-divider>
        <div class="promotion-section">
...
async function initOrderCount() {
  try {
    const response = await request.post('/api/pay/order/getOrderCount', {
...
async function initPromotions() {
  try {
    const response = await request.post('/api/good/getUserLikeInFootMark', {
      userId: UserInfoForm.value.id
    }, {
      headers: {
        'Content-Type': 'application/json;charset=UTF-8'
