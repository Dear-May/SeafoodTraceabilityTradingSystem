        ...
        <div class="row">
          <div class="col-2 d-flex align-items-center justify-content-start">
            <a href="/" class="d-flex align-items-center mb-2 mb-lg-0 link-body-emphasis text-decoration-none">
              <img src="../assets/images/logo.png" alt="Bootstrap" class="bi me-2" width="50" height="50" role="img"
          ...
          <div class="col-6 d-flex align-items-center justify-content-center" v-if="!isScrolled">
            <i class="bi bi-geo-alt-fill me-2" class="fs-20"></i>
            <span>{{ city }}</span>
            <i class="bi bi-cloud-sun-fill ms-4" class="fs-20" v-if="weather==='晴'"></i>
            <i class="bi bi-cloud-fog-fill ms-4" class="fs-20" v-if="weather==='阴'"></i>
            <i class="bi bi-cloud-rain-fill ms-4" class="fs-20" v-if="weather==='雨'"></i>
            <i class="bi bi-cloud-haze-fill ms-4" class="fs-20" v-if="weather==='雾'"></i>
            <i class="bi bi-cloud-sun-rain-fill ms-4" class="fs-20" v-if="weather==='多云'"></i>
            <i class="bi bi-cloud ms-4" class="fs-20" v-if="weather==='霾'"></i>
...
async function fetchWeather() {
  try {
    const response = await request.post('/api/other/weather1', {
...
async function initSearchProducts() {
  ...
  try {
    const response = await request.post('/api/good/get-search-result', {
...
async function handleImageSearch() {
  ...
  try {
    const response = await request.post('/api/good/image-search', formData, {
      headers: {
