      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-6 d-flex align-items-center justify-content-center" v-if="!isScrolled">
            ...
            <span>{{ city }}</span>
            <WeatherIcon :weather="weather" :size="20" />
          ...
          <div class="col-4 d-flex align-items-center justify-content-end" style="margin-left: auto;">
            <template v-if="isScrolled">
              <div <div class="weather-info d-flex align-items-center">
...
async function fetchWeather() {
  try {
    const response = await request.post('/api/other/weather', {
...
async function getCountByCategory(category) {
  try {
    const response = await request.post('/api/good/getCountByName', {
      goodName: category,
    }, {
      headers: {'Content-Type': 'application/json'},
      withCredentials: true
...
async function initProducts(name) {
  ...
  try {
    const response = await request.post('/api/good/getGoodByName', {
      goodName: name,
      page: page_1.value,
      pageSize: pageSize.value,
    }, {
