...
import com.shopping_c_backend.module.chat.ChatMessageService;
...
public class TalkController {
    ...
    public Result createChatSession(@RequestBody Map<String, String> request) {
        ...
        return chatMessageService.createChatSession(userId, shoppingId) == 1 ? Result.success() : new Result(400);
    }
    ...
    public Result deleteChatSession(@RequestBody Map<String, String> request) {
        ...
        return chatMessageService.deleteChatSession(userId, shopId) == 1 ? Result.success() : new Result(400);
    }
    ...
    public Result sendMessage(@RequestBody Map<String, String> request) {
        ...
        return chatMessageService.sendUserMessage(userId, shopId, message, "text") == 1 ? Result.success() : new Result(400);
    }
    ...
    public Result uploadFile(@RequestParam("file") MultipartFile file, @RequestParam("userId") int userId, @RequestParam("shopId") int shopId) throws IOException {
        ...
        try {
            ...
            if (result != null) {
                ...
                return chatMessageService.sendUserMessage(userId, shopId, avatarUrl, "image") == 1 ? Result.success() : new Result(400);
            }
        } catch (Exception e) {
    ...
    public Result sendOrderLink(@RequestBody Map<String, String> request) {
        ...
        return chatMessageService.sendUserMessage(userId, shopId, link, "link") == 1 ? Result.success() : new Result(400);
    }
}
